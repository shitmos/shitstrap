...
export const cw20BaseQueryKeys = {
  ...
  address: (contractAddress: string) => ([{ ...cw20BaseQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  balance: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
    method: "balance",
    args
  }] as const),
  tokenInfo: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
    method: "token_info",
    args
  }] as const),
  minter: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
    method: "minter",
    args
  }] as const),
  allowance: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
    method: "allowance",
    args
  }] as const),
  allAllowances: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
    method: "all_allowances",
    args
  }] as const),
  allSpenderAllowances: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
    method: "all_spender_allowances",
    args
  }] as const),
  allAccounts: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
    method: "all_accounts",
    args
  }] as const),
  marketingInfo: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
    method: "marketing_info",
    args
  }] as const),
  downloadLogo: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20BaseQueryKeys.address(contractAddress)[0],
...
export const cw20BaseQueries = {
  ...
  allSpenderAllowances: <TData = AllSpenderAllowancesResponse,>({
    ...
    queryFn: () => client.allSpenderAllowances({
      limit: args.limit,
      spender: args.spender,
      startAfter: args.startAfter
    }),
...
export function useCw20BaseDownloadLogoQuery<TData = DownloadLogoResponse>({
  ...
  return useQuery<DownloadLogoResponse, Error, TData>(cw20BaseQueryKeys.downloadLogo(client.contractAddress), () => client.downloadLogo(), options);
}
...
export function useCw20BaseMarketingInfoQuery<TData = MarketingInfoResponse>({
  ...
  return useQuery<MarketingInfoResponse, Error, TData>(cw20BaseQueryKeys.marketingInfo(client.contractAddress), () => client.marketingInfo(), options);
}
...
export function useCw20BaseAllAccountsQuery<TData = AllAccountsResponse>({
  ...
  return useQuery<AllAccountsResponse, Error, TData>(cw20BaseQueryKeys.allAccounts(client.contractAddress, args), () => client.allAccounts({
    limit: args.limit,
    startAfter: args.startAfter
  }), options);
}
...
export function useCw20BaseAllSpenderAllowancesQuery<TData = AllSpenderAllowancesResponse>({
  ...
  return useQuery<AllSpenderAllowancesResponse, Error, TData>(cw20BaseQueryKeys.allSpenderAllowances(client.contractAddress, args), () => client.allSpenderAllowances({
    limit: args.limit,
    spender: args.spender,
    startAfter: args.startAfter
  }), options);
...
export function useCw20BaseAllAllowancesQuery<TData = AllAllowancesResponse>({
  ...
  return useQuery<AllAllowancesResponse, Error, TData>(cw20BaseQueryKeys.allAllowances(client.contractAddress, args), () => client.allAllowances({
    limit: args.limit,
    owner: args.owner,
    startAfter: args.startAfter
  }), options);
...
export function useCw20BaseAllowanceQuery<TData = AllowanceResponse>({
  ...
  return useQuery<AllowanceResponse, Error, TData>(cw20BaseQueryKeys.allowance(client.contractAddress, args), () => client.allowance({
    owner: args.owner,
    spender: args.spender
  }), options);
}
...
export function useCw20BaseMinterQuery<TData = MinterResponse>({
  ...
  return useQuery<MinterResponse, Error, TData>(cw20BaseQueryKeys.minter(client.contractAddress), () => client.minter(), options);
}
...
export function useCw20BaseTokenInfoQuery<TData = TokenInfoResponse>({
  ...
  return useQuery<TokenInfoResponse, Error, TData>(cw20BaseQueryKeys.tokenInfo(client.contractAddress), () => client.tokenInfo(), options);
}
...
export function useCw20BaseBalanceQuery<TData = BalanceResponse>({
  ...
  return useQuery<BalanceResponse, Error, TData>(cw20BaseQueryKeys.balance(client.contractAddress, args), () => client.balance({
    address: args.address
  }), options);
}
